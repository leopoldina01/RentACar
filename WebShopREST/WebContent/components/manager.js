Vue.component("manager", {
	data: function () {
	    return {
			...
			//manager : {id: -1, username: '', password: '', firstName: '', lastName: '', gender: '', dateOfBirth: '', role: 'MANAGER', rentACarStore: ''},
			updatedUser : {id: -1, username: '', password: '', firstName: '', lastName: '', gender: '', dateOfBirth: '', role: 'MANAGER', isBlocked: ''},
			updatedUsername: '',
			updatedPassword: '',
			updatedFirstname: '',
			updatedLastname: '',
	...
	<div>
		<header>
			...
			<div class = nav-buttons>
				<button v-on:click="showStore"><i class="fas fa-eye"></i> My store</button>
